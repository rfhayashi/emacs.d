...
*** Emacs Setup
   #+begin_src emacs-lisp
     ...
     (use-package cider
       ...
       (setq cider-clojure-cli-global-options "-A:portal -A:injections -J-XX:-OmitStackTraceInFastThrow")
...
#+begin_src emacs-lisp
  (defun clerk-show ()
    (let ((file-name (buffer-file-name)))
      (message (concat "clerk show: " file-name))
      (cider-interactive-eval
       (concat "(nextjournal.clerk/show! \"" file-name "\")"))))
